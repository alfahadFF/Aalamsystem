/* ============================================================
   ...
   ============================================================ */
const VERSION = 'alfaprosys-v100'; /* v96: قاعدة البيانات من الشبكة · v97: معالجة أخطاء الجلب · v98: مفتاح الطلبات المركّب · v99: لا فشل صامت في التحميل · v100: مكتبة الطباعة من الكاش فوراً */
...
self.addEventListener('fetch', (event) => {
  ...
  /* ── استدعاءات قاعدة البيانات (Supabase REST): شبكة دائماً ──────────
     كانت تُعامل كـ«أصل خارجي» فتُخزَّن في الكاش ويُقدَّم الرد القديم
     نفسه إلى الأبد. النتيجة: بعد حفظ إعدادات الطباعة تعيد الصفحة تحميلها
