...
window.ALFA_CONFIG = {
  ...
  thermal: {
    ...
    /* أسماء المشاركة على الشبكة (ويندوز يفرض غالباً بلا فراغات).
       النظام يجرّب المحلي أولاً ثم هذه الأسماء تلقائياً — بلا اختيار يدوي. */
    printerCashierAliases: ['RONGTA80mm2'],       // كاشير مشترك
    printerKitchenAliases: ['RONGTA80mm1'],       // مطبخ مشترك

    /* عناوين QZ على الشبكة (الجهاز الرئيسي) — تُجرَّب تلقائياً إن لم
       تُوجد الطابعات على هذا الجهاز. مثال: ['192.168.1.10']
       يمكن أيضاً حفظ العنوان محلياً: localStorage alfaprosys_qz_host */
    qzHosts: ['192.168.1.235'],  // IP الجهاز الرئيسي (الطابعات مربوطة به)
