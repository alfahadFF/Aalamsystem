...
window.ALFA_CONFIG = {
  ...
  restaurantName: 'عالم الفواكه',
    ...
    /* عروض أعمدة جدول الأصناف — نسبة مئوية من عرض الجدول (المجموع 100).
       مقيسة على ورق ٧١ مم: كل عمود رقمي يحمل محتواه في سطر واحد
       («1.00» للكمية · «25,000» للسعر والإجمالي · «بدون بصل» للملاحظة).
       اسم المادة أوسع عمود؛ عرض الجدول نفسه ثابت لا يتغيّر.
       عدّل الأرقام كما تشاء — المجموع يجب أن يبقى 100. */
    cols: { name: 30, qty: 15, price: 16, total: 17, note: 22 },
