...
(window.alfaStart||function(fn){fn();})(function () {
  ...
  if (window.OnlineOrderSync && OnlineOrderSync.pull) {
    /* سحب فوري: الشاشة كانت ترسم فوراً ببيانات فارغة ثم تنتظر أول
       نبضة المؤقت (٣٠ ثانية) قبل أن تسحب وترسم — فيظنّ المستخدم أن
       جلب الطلبات معطّل بالكامل. */
    OnlineOrderSync.pull()
      .then(function () { renderAll(); if (window.Notify) Notify.check(false); })
      .catch(function () {});
